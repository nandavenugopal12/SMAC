...
const styles = StyleSheet.create({
  ...
  page: { width: '100%', maxWidth: 620, alignSelf: 'center', padding: 18 }, eyebrow: { alignSelf: 'flex-start', borderWidth: 1, borderColor: theme.colors.ink, borderRadius: 99, paddingHorizontal: 10, paddingVertical: 6, color: theme.colors.ink, fontSize: 9, fontWeight: '900', letterSpacing: 1 }, title: { marginTop: 16, color: theme.colors.ink, fontSize: 36, lineHeight: 39, fontWeight: '900', letterSpacing: -1.5 }, summary: { marginTop: 8, color: theme.colors.muted, fontSize: 14, lineHeight: 20 },
  progressCopy: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 22, marginBottom: 7 }, progressText: { color: theme.colors.muted, fontSize: 9, fontWeight: '900', letterSpacing: .8 }, percent: { color: theme.colors.ink, fontSize: 11, fontWeight: '900' }, progressTrack: { height: 10, borderRadius: 5, backgroundColor: 'rgba(21,40,32,.12)', overflow: 'hidden' }, progressFill: { height: '100%', minWidth: 3, backgroundColor: theme.colors.orange }, section: { marginTop: 32, marginBottom: 12, color: theme.colors.ink, fontSize: 10, fontWeight: '900', letterSpacing: 1.2 },
  taskWrap: { marginBottom: 13 }, taskCard: { borderWidth: 1, borderColor: theme.colors.ink, borderRadius: 17, padding: 16, backgroundColor: theme.colors.white }, taskTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, number: { color: theme.colors.muted, fontSize: 10, fontWeight: '900' }, skill: { paddingHorizontal: 9, paddingVertical: 5, borderRadius: 99, backgroundColor: theme.colors.lime }, driveSkill: { backgroundColor: theme.colors.blue }, skillText: { color: theme.colors.ink, fontSize: 8, fontWeight: '900', letterSpacing: .7 }, taskTitle: { marginTop: 12, color: theme.colors.ink, fontSize: 19, lineHeight: 23, fontWeight: '900' }, description: { marginTop: 4, color: theme.colors.muted, fontSize: 12, lineHeight: 18 }, destination: { marginTop: 10, color: theme.colors.ink, fontSize: 11, fontWeight: '800' }, contributors: { marginTop: 12, color: theme.colors.muted, fontSize: 10, fontWeight: '700' },
  timerRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 14, paddingTop: 12, borderTopWidth: 1, borderTopColor: theme.colors.border }, timerLabel: { color: theme.colors.muted, fontSize: 8, fontWeight: '900', letterSpacing: .8 }, timer: { color: theme.colors.orange, fontSize: 15, fontWeight: '900', fontVariant: ['tabular-nums'] }, action: { minHeight: 46, marginTop: 12, borderRadius: 23, paddingHorizontal: 16, backgroundColor: theme.colors.ink, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, actionText: { color: theme.colors.white, fontSize: 11, fontWeight: '900' }, actionArrow: { color: theme.colors.lime, fontSize: 18 }, disabled: { opacity: .38 }, done: { marginTop: 14, borderRadius: 12, padding: 11, backgroundColor: theme.colors.mint, alignItems: 'center' }, doneText: { color: theme.colors.ink, fontSize: 10, fontWeight: '900', letterSpacing: 1 }, error: { color: theme.colors.error, fontWeight: '800', textAlign: 'center', marginTop: 10 }, missing: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 30 }, bottomSpace: { height: 30 },
});
